...
function drawRhythmicSpiral() {
  ...
  const pattern = ["big", "small", "small", "big", "small", "small"]; //старый вариант

  // Вычисляем общую ширину
  /*const totalWidth = canvas.width * 0.75;
    const startX = (canvas.width - totalWidth) / 2;*/ //Оставляем размер спирали как есть (75% ширины экрана), но сдвигаем влево
  const totalWidth = canvas.width * 0.75;
